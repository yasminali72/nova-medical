...
export async function ServiceCard({ service }: ServiceCardProps) {
  ...
  return (
    <div className="group relative flex flex-col justify-between p-8 rounded-3xl bg-card border border-border/80 hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/10 transition-all duration-300 overflow-hidden">
      {/* Ambient gradient */}
