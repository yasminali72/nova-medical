              ...
              {service.duration && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-foreground">{t(service.duration)}</p>
                  </div>
                </div>
              )}
              <Link
                href="/contact"
                className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-primary text-white text-sm font-bold shadow-md shadow-primary/25 hover:opacity-90 transition"
              >
