            ...
            <div className="flex flex-wrap gap-3">
              {doctor.experience && (
                <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-card border border-border/80 text-sm">
                  ...
                  <span className="text-muted-foreground">{t(doctor.experience)}</span>
                </div>
              )}
              {doctor.languages && (
                <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-card border border-border/80 text-sm">
                  <Globe className="w-4 h-4 text-primary" />
                  <span className="text-muted-foreground">{t(doctor.languages)}</span>
                </div>
              )}
            </div>
            ...
            {doctor.education && (
              <div className="p-6 rounded-2xl bg-card border border-border/80 space-y-3">
                ...
                <ul className="space-y-2">
                  {doctor.education.map((edu: string) => (
